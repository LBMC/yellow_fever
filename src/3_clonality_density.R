...
print(g)
ggsave(file = "results/clonality/pMEM_density_by_clone_D15.pdf")
...
g <- ggplot(tmp_infos,
  ...
  theme(
    ...
    strip.background = element_blank())
print(g)
ggsave(file = "results/clonality/pMEM_density_D15.pdf")
...
g <- ggplot(tmp_infos[!is.na(tmp_infos$clonality), ],
  ...
  theme(
    ...
    strip.background = element_blank())
print(g)
ggsave(file = "results/clonality/pMEM_density_by_clone_D100+.pdf")
...
g <- ggplot(tmp_infos,
  ...
  theme(
    ...
    strip.background = element_blank())
print(g)
ggsave(file = "results/clonality/pMEM_density_D100+.pdf")
